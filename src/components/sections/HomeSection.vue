<template>
    <section class="pt-16 pb-25 min-h-screen-75 space">

        <div class="text-amber-200 py-20 px-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-6 gap-4 x-gap pr-3 py-4">
                <div class="xl:col-span-2 md:col-span-6 sm:col-span-6">
                    <button
                        class="btn border-dotted border-2 border-yellow-500  text-yellow-700 font-bold py-2">CHART</button>
                </div>
                <div>
                    <button
                        class="border-dotted border-2 border-yellow-500 btn dark:bg-gray-800 hover:bg-blue-200 text-pink font-bold py-2">BUY</button>
                </div>
            </div>
    ...
    <section id="about" class="backdrop-blur">
        <div class="border border-pink-200 bg-blue-200 items-center px-20">

            <div class="flex justify-center">
                <div class="border-dotted border-2 border-yellow-500 border-blue-200 bg-white items-center ">
                    ...
                    <table class="table-auto border-collapse w-full">
                        ...
                        <tbody class="text-sm font-normal text-white">
                            ...
                            <tr class="border-gray-200">
                                <td class="px-4 py-4"> 0*0ndsndsasasshjsasa</td>
                                <td class="px-4 py-4">20000000000</td>
    ...
    <section class="dark:bg-gray-800 pt-5">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 x-gap pr-3 py-4 pr-2">
            <div class="border border-blue-200 bg-blue-200 items-center ">
                <h3 class="pb-2 text-center">AUTO PIOLOTS</h3>
                <p class="p-2">
                    {{ content }}
                </p>
            </div>
    ...
    <section class="dark:bg-gray-800 p-5">

        <h2 class="text-center text-amber-200 font-bold text-4xl tracking-wider">
            ROADMAP
        </h2>
    ...
    <section class="dark:bg-gray-800  from-pink-50 to-indigo-100 p-8">
    <h1 class="text-center font-bold text-2xl text-yellow-500">Lore</h1>
    <hr class="border-2 border-blue-200 mb-5" />

    <div class="grid justify-center md:grid-cols-1 lg:grid-cols-1 gap-5 lg:gap-7 my-10">
        <!-- Card 1 -->
        <div class="bg-white rounded-lg border shadow-md max-w-xs md:max-w-none overflow-hidden" v-for="lo in lore" :key="lo.title">
            ...
            <div class="p-3">
                ...
                <p class="paragraph-normal text-gray-600 text-overflow-handle" v-if="!lo.load">
                    {{ lo.desc }}
                </p>
                
                <p class="" v-if="lo.load">
                    {{ lo.desc }}
                </p>
                
                
                <button class="mt-3 block" href="#" v-on:click="lo.load = !lo.load">
                    Read More </button>
            </div>
        </div>
