  ...
  <nav class="backdrop-blur fixed w-full z-23 top-0 left-0 bg-black/50">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3 lg:p-6">
      ...
      <div class="flex md:order-2 space-x-0.5">
        ...
        <a  style="font-size: 19px;/*! margin-left: -2px; */position: relative;right: 5px;height: 41px;" href="#" class="border-dotted border-2 border-white  w-12">
        ...
        <a href="#" class="mx-5 border-dotted border-2 border-white  w-12">
          <svg style="position: relative; top: 8px; left: 11px;" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-telegram text-white" viewBox="0 0 16 16">
