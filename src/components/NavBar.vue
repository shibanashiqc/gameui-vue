<template>
  <nav class="backdrop-blur fixed w-full z-23 top-0 left-0 bg-black/80">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2 lg:p-3">
      ...
      <!-- <a href="#" class="lg:invisible text-white rounded-lg font-serif bg-[#057bf9] flex">
     <img src="../assets/te.png" alt="telegram" class="w-28 h-18"> 
      ...
      <div class="bg-[#057bf9] font-sans  rounded-lg lg:invisible">
        <a href="#">
          <div class="pl-1 p-1 flex">
            ...
            <p class="text-white pr-2 font-bold">
